...
<body>
	<?php 
		$sql = 'select m.num,m.s_code,m.phone,m.r_id,r.m_name,r.h_name,r.time,r.m_time,r.start_time,r.end_time,r.m_price,r.m_id from morder m left join relss r on m.r_id=r.id where m.id ='.$_GET['order_id'];
