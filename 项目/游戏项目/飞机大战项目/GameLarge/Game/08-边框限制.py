...
print(plane_rect.left)
print(plane_rect.right)
print(plane_rect.top)
print(plane_rect.bottom)
print(plane_rect.center)
print(plane_rect.centerx)
print(plane_rect.centery)
# 1.3 扣出 飞机	
